...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set clko [ create_bd_port -dir O -type clk clko ]
  set gpi01 [ create_bd_port -dir I -from 31 -to 0 gpi01 ]
  set gpi02 [ create_bd_port -dir I -from 31 -to 0 gpi02 ]
  set gpo01 [ create_bd_port -dir O -from 31 -to 0 gpo01 ]
  set gpo02 [ create_bd_port -dir O -from 31 -to 0 gpo02 ]
  set rstno [ create_bd_port -dir O -from 0 -to 0 -type rst rstno ]
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_ports gpo02] [get_bd_pins axi_gpio_0/gpio2_io_o]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports gpo01] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net gpi01_1 [get_bd_ports gpi01] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net gpi02_1 [get_bd_ports gpi02] [get_bd_pins axi_gpio_0/gpio2_io_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports clko] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_ports rstno] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
